...
# ===== for X-305 Daedalus   version 3.0                 =======
...
#			walker0_node.getNode("trigger-upon", 1).setValue(i3);
	...
	showDialog: func {
		...
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -135);	# -135 minus pilot sitting offset
		box.set("max", 45);	#   45 minus pilot sitting offset
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		...
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -65.5);	# -90.5 minus pilot sitting offset
		box.set("max", 87.5);	#  62.5 minus pilot sitting offset
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
...
#		g.addChild("empty").set("pref-width", 4);
		...
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -53);	#   0 minus pilot sitting offset
		box.set("max", 97);	# 150 minus pilot sitting offset
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
...
#		g.addChild("empty").set("pref-width", 2);
		...
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -61.0);	# -135 minus pilot sitting offset
		box.set("max", 155.0);	#   81 minus pilot sitting offset
		box.setColor(0.5, 1, 0.5);
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		...
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -10);	# -45 minus pilot sitting offset
		box.set("max", 80);	#  45 minus pilot sitting offset
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
